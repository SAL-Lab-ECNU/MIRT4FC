...
singleI_2PL_4_rank <- function(theta,item.par,BID,Y,model,I,h=NULL){
  grad_FDM_item_2PL_4_rank <- function(theta,a,d,x=c(1,2,3,4),h){#一个block内的一阶导，#a=c(ai,aj,ak) d=c(di,dj,dk) theta=c(thetai,thetaj,thetak)
    ...
    g.ia <- (px_2PL_4_rank(theta,a+c(h,0,0,0),d,x)-px_2PL_4_rank(theta,a,d,x))/h
    g.ja <- (px_2PL_4_rank(theta,a+c(0,h,0,0),d,x)-px_2PL_4_rank(theta,a,d,x))/h
    g.ka <- (px_2PL_4_rank(theta,a+c(0,0,h,0),d,x)-px_2PL_4_rank(theta,a,d,x))/h
    g.la <- (px_2PL_4_rank(theta,a+c(0,0,0,h),d,x)-px_2PL_4_rank(theta,a,d,x))/h
    g.id <- (px_2PL_4_rank(theta,a,d+c(h,0,0,-h),x)-px_2PL_4_rank(theta,a,d,x))/h
    g.jd <- (px_2PL_4_rank(theta,a,d+c(0,h,0,-h),x)-px_2PL_4_rank(theta,a,d,x))/h
    g.kd <- (px_2PL_4_rank(theta,a,d+c(0,0,h,-h),x)-px_2PL_4_rank(theta,a,d,x))/h
  ...
  grad_CDM_item_2PL_4_rank <- function(theta,a,d,x=c(1,2,3,4),h){#一个block内的一阶导，#a=c(ai,aj,ak) d=c(di,dj,dk) theta=c(thetai,thetaj,thetak)
    ...
    g.ia <- (px_2PL_4_rank(theta,a+c(h,0,0,0),d,x)-px_2PL_4_rank(theta,a-c(h,0,0,0),d,x))/2*h
    g.ja <- (px_2PL_4_rank(theta,a+c(0,h,0,0),d,x)-px_2PL_4_rank(theta,a-c(0,h,0,0),d,x))/2*h
    g.ka <- (px_2PL_4_rank(theta,a+c(0,0,h,0),d,x)-px_2PL_4_rank(theta,a-c(0,0,h,0),d,x))/2*h
    g.la <- (px_2PL_4_rank(theta,a+c(0,0,0,h),d,x)-px_2PL_4_rank(theta,a-c(0,0,0,h),d,x))/2*h
    g.id <- (px_2PL_4_rank(theta,a,d+c(h,0,0,-h),x)-px_2PL_4_rank(theta,a,d-c(h,0,0,-h),x))/2*h
    g.jd <- (px_2PL_4_rank(theta,a,d+c(0,h,0,-h),x)-px_2PL_4_rank(theta,a,d-c(0,h,0,-h),x))/2*h
    g.kd <- (px_2PL_4_rank(theta,a,d+c(0,0,h,-h),x)-px_2PL_4_rank(theta,a,d-c(0,0,h,-h),x))/2*h
    c(g.ia,g.ja,g.ka,g.la,g.id,g.jd,g.kd)
  }
  grad_RES_item_2PL_4_rank <- function(theta,a,d,x=c(1,2,3,4),h){#一个block内的一阶导，#a=c(ai,aj,ak) d=c(di,dj,dk) theta=c(thetai,thetaj,thetak)
    ...
    g.ia <- (px_2PL_4_rank(theta,a-c(2*h,0,0,0),d,x)+8*px_2PL_4_rank(theta,a+c(h,0,0,0),d,x)
             -px_2PL_4_rank(theta,a+c(2*h,0,0,0),d,x)-8*px_2PL_4_rank(theta,a-c(h,0,0,0),d,x))/12*h
    g.ja <- (px_2PL_4_rank(theta,a-c(0,2*h,0,0),d,x)+8*px_2PL_4_rank(theta,a+c(0,h,0,0),d,x)
             -px_2PL_4_rank(theta,a+c(0,2*h,0,0),d,x)-8*px_2PL_4_rank(theta,a-c(0,h,0,0),d,x))/12*h
    g.ka <- (px_2PL_4_rank(theta,a-c(0,0,2*h,0),d,x)+8*px_2PL_4_rank(theta,a+c(0,0,h,0),d,x)
             -px_2PL_4_rank(theta,a+c(0,0,2*h,0),d,x)-8*px_2PL_4_rank(theta,a-c(0,0,h,0),d,x))/12*h
    g.la <- (px_2PL_4_rank(theta,a-c(0,0,0,2*h),d,x)+8*px_2PL_4_rank(theta,a+c(0,0,0,h),d,x)
             -px_2PL_4_rank(theta,a+c(0,0,0,2*h),d,x)-8*px_2PL_4_rank(theta,a-c(0,0,0,h),d,x))/12*h
    g.id <- (px_2PL_4_rank(theta,a,d-c(2*h,0,0,-2*h),x)+8*px_2PL_4_rank(theta,a,d+c(h,0,0,-h),x)
             -px_2PL_4_rank(theta,a,d+c(2*h,0,0,-2*h),x)-8*px_2PL_4_rank(theta,a,d-c(h,0,0,-h),x))/12*h
    g.jd <- (px_2PL_4_rank(theta,a,d-c(0,2*h,0,-2*h),x)+8*px_2PL_4_rank(theta,a,d+c(0,h,0,-h),x)
             -px_2PL_4_rank(theta,a,d+c(0,2*h,0,-2*h),x)-8*px_2PL_4_rank(theta,a,d-c(0,h,0,-h),x))/12*h
    g.kd <- (px_2PL_4_rank(theta,a,d-c(0,0,2*h,-2*h),x)+8*px_2PL_4_rank(theta,a,d+c(0,0,h,-h),x)
             -px_2PL_4_rank(theta,a,d+c(0,0,2*h,-2*h),x)-8*px_2PL_4_rank(theta,a,d-c(0,0,h,-h),x))/12*h
    c(g.ia,g.ja,g.ka,g.la,g.id,g.jd,g.kd)
  }
  ...
  XPDEss_item_2PL_4_rank <- function(theta,a,d,Y){
    ...
    g <- grad_item_2PL_4_rank(theta,a,d,x=all.x[[Y]])
    ret <- tcrossprod(g,g)/px_2PL_4_rank(theta,a,d,xx=all.x[[Y]])^2

    ret
  }
  FDMEss_item_2PL_4_rank <- function(theta,a,d,Y,h=1e-5){
    all.x <- list(c(1,2,3,4),c(1,2,4,3),c(1,3,2,4),c(1,3,4,2),c(1,4,2,3),c(1,4,3,2),
                  c(2,1,3,4),c(2,1,4,3),c(2,3,1,4),c(2,3,4,1),c(2,4,1,3),c(2,4,3,1),
                  c(3,1,2,4),c(3,1,4,2),c(3,2,1,4),c(3,2,4,1),c(3,4,1,2),c(3,4,2,1),
                  c(4,1,2,3),c(4,1,3,2),c(4,2,1,3),c(4,2,3,1),c(4,3,1,2),c(4,3,2,1))
    g <- grad_FDM_item_2PL_4_rank(theta,a,d,x=all.x[[Y]],h=h)
    ret <- tcrossprod(g,g)/px_2PL_4_rank(theta,a,d,xx=all.x[[Y]])^2

    ret
  }
  RESEss_item_2PL_4_rank <- function(theta,a,d,Y,h=1){
    all.x <- list(c(1,2,3,4),c(1,2,4,3),c(1,3,2,4),c(1,3,4,2),c(1,4,2,3),c(1,4,3,2),
                  c(2,1,3,4),c(2,1,4,3),c(2,3,1,4),c(2,3,4,1),c(2,4,1,3),c(2,4,3,1),
                  c(3,1,2,4),c(3,1,4,2),c(3,2,1,4),c(3,2,4,1),c(3,4,1,2),c(3,4,2,1),
                  c(4,1,2,3),c(4,1,3,2),c(4,2,1,3),c(4,2,3,1),c(4,3,1,2),c(4,3,2,1))
    g <- grad_RES_item_2PL_4_rank(theta,a,d,x=all.x[[Y]],h=h)
    ret <- tcrossprod(g,g)/px_2PL_4_rank(theta,a,d,xx=all.x[[Y]])^2

    ret
  }
  CDMEss_item_2PL_4_rank <- function(theta,a,d,Y,h=1){
    all.x <- list(c(1,2,3,4),c(1,2,4,3),c(1,3,2,4),c(1,3,4,2),c(1,4,2,3),c(1,4,3,2),
                  c(2,1,3,4),c(2,1,4,3),c(2,3,1,4),c(2,3,4,1),c(2,4,1,3),c(2,4,3,1),
                  c(3,1,2,4),c(3,1,4,2),c(3,2,1,4),c(3,2,4,1),c(3,4,1,2),c(3,4,2,1),
                  c(4,1,2,3),c(4,1,3,2),c(4,2,1,3),c(4,2,3,1),c(4,3,1,2),c(4,3,2,1))
    g <- grad_CDM_item_2PL_4_rank(theta,a,d,x=all.x[[Y]],h=h)
    ret <- tcrossprod(g,g)/px_2PL_4_rank(theta,a,d,xx=all.x[[Y]])^2
  ...
  FDMSS_item_2PL_4_rank <- function(theta,a,d,Y,h=1e-5){
    all.x <- list(c(1,2,3,4),c(1,2,4,3),c(1,3,2,4),c(1,3,4,2),c(1,4,2,3),c(1,4,3,2),
                  c(2,1,3,4),c(2,1,4,3),c(2,3,1,4),c(2,3,4,1),c(2,4,1,3),c(2,4,3,1),
                  c(3,1,2,4),c(3,1,4,2),c(3,2,1,4),c(3,2,4,1),c(3,4,1,2),c(3,4,2,1),
                  c(4,1,2,3),c(4,1,3,2),c(4,2,1,3),c(4,2,3,1),c(4,3,1,2),c(4,3,2,1))
  ...
  RESSS_item_2PL_4_rank <- function(theta,a,d,Y,h=1){
    all.x <- list(c(1,2,3,4),c(1,2,4,3),c(1,3,2,4),c(1,3,4,2),c(1,4,2,3),c(1,4,3,2),
                  c(2,1,3,4),c(2,1,4,3),c(2,3,1,4),c(2,3,4,1),c(2,4,1,3),c(2,4,3,1),
                  c(3,1,2,4),c(3,1,4,2),c(3,2,1,4),c(3,2,4,1),c(3,4,1,2),c(3,4,2,1),
                  c(4,1,2,3),c(4,1,3,2),c(4,2,1,3),c(4,2,3,1),c(4,3,1,2),c(4,3,2,1))
  ...
  CDMSS_item_2PL_4_rank <- function(theta,a,d,Y,h=1){
    all.x <- list(c(1,2,3,4),c(1,2,4,3),c(1,3,2,4),c(1,3,4,2),c(1,4,2,3),c(1,4,3,2),
                  c(2,1,3,4),c(2,1,4,3),c(2,3,1,4),c(2,3,4,1),c(2,4,1,3),c(2,4,3,1),
                  c(3,1,2,4),c(3,1,4,2),c(3,2,1,4),c(3,2,4,1),c(3,4,1,2),c(3,4,2,1),
                  c(4,1,2,3),c(4,1,3,2),c(4,2,1,3),c(4,2,3,1),c(4,3,1,2),c(4,3,2,1))
  ...
  XPDSS_item_2PL_4_rank <- function(theta,a,d,Y){
    all.x <- list(c(1,2,3,4),c(1,2,4,3),c(1,3,2,4),c(1,3,4,2),c(1,4,2,3),c(1,4,3,2),
                  c(2,1,3,4),c(2,1,4,3),c(2,3,1,4),c(2,3,4,1),c(2,4,1,3),c(2,4,3,1),
                  c(3,1,2,4),c(3,1,4,2),c(3,2,1,4),c(3,2,4,1),c(3,4,1,2),c(3,4,2,1),
                  c(4,1,2,3),c(4,1,3,2),c(4,2,1,3),c(4,2,3,1),c(4,3,1,2),c(4,3,2,1))
  ...
  itemI_2PL_4_rank <- function(theta,item.par,BID,Y,I,h=NULL){
    ...
    for(b in unique(BID$Block)){
      ...
      Y.b <- Y[b]
      if(I=="XPD"){
        itemIEss[item,item] <- XPDEss_item_2PL_4_rank(theta.b,a.b,d.b,Y.b)
        itemISS[item] <- XPDSS_item_2PL_4_rank(theta.b,a.b,d.b,Y.b)
      }else if(I=="FDM"){
        if(is.null(h)){
          itemIEss[item,item] <- FDMEss_item_2PL_4_rank(theta.b,a.b,d.b,Y.b)
          itemISS[item] <- FDMSS_item_2PL_4_rank(theta.b,a.b,d.b,Y.b)
        }else{
          itemIEss[item,item] <- FDMEss_item_2PL_4_rank(theta.b,a.b,d.b,Y.b,h=h)
          itemISS[item] <- FDMSS_item_2PL_4_rank(theta.b,a.b,d.b,Y.b,h=h)
        }
      }else if(I=="CDM"){
        if(is.null(h)){
          itemIEss[item,item] <- CDMEss_item_2PL_4_rank(theta.b,a.b,d.b,Y.b)
          itemISS[item] <- CDMSS_item_2PL_4_rank(theta.b,a.b,d.b,Y.b)
        }else{
          itemIEss[item,item] <- CDMEss_item_2PL_4_rank(theta.b,a.b,d.b,Y.b,h=h)
          itemISS[item] <- CDMSS_item_2PL_4_rank(theta.b,a.b,d.b,Y.b,h=h)
        }
      }else if(I=="RES"){
        if(is.null(h)){
          itemIEss[item,item] <- RESEss_item_2PL_4_rank(theta.b,a.b,d.b,Y.b)
          itemISS[item] <- RESSS_item_2PL_4_rank(theta.b,a.b,d.b,Y.b)
        }else{
          itemIEss[item,item] <- RESEss_item_2PL_4_rank(theta.b,a.b,d.b,Y.b,h=h)
          itemISS[item] <- RESSS_item_2PL_4_rank(theta.b,a.b,d.b,Y.b,h=h)
        }
      }
    }
  ...
  sinI_matrix=foreach(i = seq_len(nrow(theta)),.inorder=FALSE,.combine='+',.export = c("foreach","%dopar%","px_2PL_4_rank"))%dopar%{
                                                                                         itemI_2PL_4_rank(theta[i,],item.par,BID,Y[i,],I,h=h)$itemIEss
                                                                                       }
  sinI_vector=foreach(i = seq_len(nrow(theta)),.inorder=FALSE,.combine='+',.export = c("foreach","%dopar%","px_2PL_4_rank"))%dopar%{
                                                                                         itemI_2PL_4_rank(theta[i,],item.par,BID,Y[i,],I,h=h)$itemISS
                                                                                       }
  list(sinI_matrix=sinI_matrix,sinI_vector=sinI_vector)
}

itemSE_2PL_4_rank <- function(x,BID,Y,model,SE,IN,theta,h=NULL){


  matrix=singleI_2PL_4_rank(theta=theta,item.par=data.frame(c(x$a),c(x$d)),BID=BID,Y=Y,I=SE,model=model,h=h)$sinI_matrix
  vector=singleI_2PL_4_rank(theta=theta,item.par=data.frame(c(x$a),c(x$d)),BID=BID,Y=Y,I=SE,model=model,h=h)$sinI_vector
